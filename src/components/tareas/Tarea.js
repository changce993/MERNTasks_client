...
const Tarea = ({tarea}) => {
    ...
    const {eliminarTarea, obtenerTareas, modificarEstadoTarea, seleccionarTarea} = tareasContext
    ...
    return (
        <li className="flex">
            ...
            <div className="flex">
                ...
                <button onClick={() => tareaEliminar(tarea.id)} className="button task_icon trash">
